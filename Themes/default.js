...
export default {
    ...
    // Button
    btnFontFamily: (Platform.OS === 'ios' ) ? 'Arial Rounded MT Bold' : 'Arial Rounded MT Bold',
    ...
    // Font
    fontFamily: (Platform.OS === 'ios' ) ? 'Arial Rounded MT Bold' : 'Arial Rounded MT Bold',
    fontSizeBase: 15,
    ...
    toolbarDefaultBg: (Platform.OS === 'ios') ? '#005e2d' : '#4179F7',
